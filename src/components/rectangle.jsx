    ...
    if (score === 5) {
        ...
        return (
            <div className="mt-5 container text-center shadow p-3 mb-5 bg-body rounded background-image-post-inside h4">
                ...
                <div><img src="https://www.legamaster.com/uploads/MAM/web/Legamaster/Graphics/Assortment%20images/Accessories/Magnetic%20symbols/Magnetic%20symbol%20rectangle/7-444702_001.png" width = "80" height = "80" alt="triangle" /></div> 
                <div className="mt-3 mb-3" > ¿Cúal es el perimetro y Area de un rectangulo si la base mide {num1} y la altura mide {num2}  </div>
                </div>
